...
public class Main {
    ...
    public static void main(String[] args) {
        CLAP clap = new CLAP();
        CLAPValue<String> hostNameOption =
                clap.addOption1(String.class, 'b', "bind", false, "Bind hostname", "bind");
        CLAPValue<Integer> httpPortOption =
                clap.addOption1(Integer.class, 'p', "httpPort", false, "Http port", "httpPort");
        CLAPValue<Integer> websocketPortOption =
                clap.addOption1(Integer.class, 'w', "wsPort", false, "Websocket port", "wsPort");
        ...
        Server httpServer =
                new Server(ObjectUtils.defaultIfNull(result.getValue(httpPortOption), 8085));
        final SocketIOServer server = new SocketIOServer(config);

        RemotingServer<String> remotingServer =
                new SocketIORemotingServer<>(server, String.class, DomSharingSession::new);
